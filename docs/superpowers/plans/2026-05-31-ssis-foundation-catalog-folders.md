...
# once per shell — prepend BOTH the built module and the resolved RequiredModules
# (importing the module pulls in dbatools.library, which lives under output/RequiredModules):
